  ...
  return (
    <button
      ...
      className={cn(
        ...
        "hover:bg-black/[0.04] hover:brightness-95 active:scale-[0.97] disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 dark:hover:bg-white/[0.06] dark:hover:brightness-110",
        sizeStyles[size],
        fullWidth && "w-full",
        className,
      )}
